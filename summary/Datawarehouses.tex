...
% section normalized_vs_dimensional_models (end)

\section{Fact Tables} % (fold)
...
% A fact table's grain is the dimension of the measurement event that produces the fact row. All the
% rows in a fact table should have a single uniform grain.

% section fact_tables (end)
